...
app_server_image_regex = "tomcat-7-v20190809132512-local-build"
#"tomcat-7-v20190729090444-local-build" 
mongo_server_image_regex = "^mongodb-32-v\\d{14}" 
vcs_beanstore_image_regex = "tomcat-7-v20190729090444-local-build"
app_dds_server_image_regex = "tomcat-7-v20190729090444-local-build"
etl_app_server_image_regex = "tomcat-7-v20190729090444-local-build"
app_ddshelper_server_image_regex = "tomcat-7-v20190729090444-local-build"
